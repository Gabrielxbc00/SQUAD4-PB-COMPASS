...
def lambda_handler(event, context):
    ...
    chave_arquivo = f"raw/tmdb/json/{tempo_atual}/blade_runner_2049_details.json"
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('Detalhes do filme Blade Runner 2049 inseridos com sucesso no S3!')
    }
